...
It can be used for a basic workstation setup. It can also be sued for lab environemnts, demo's, tutorials and workshops. It uses a ubuntu 18.04 distro (MEM 4GB, CPU 2). It runs with a private static IP. (192.168.1.10) You can find the following tools here:
